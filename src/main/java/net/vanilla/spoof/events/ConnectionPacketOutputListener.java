 ...
 */
package net.vanilla.spoof.events;

import java.util.ArrayList;

import net.minecraft.network.packet.Packet;
import net.vanilla.spoof.event.CancellableEvent;
import net.vanilla.spoof.event.Listener;
import net.vanilla.spoof.events.PacketOutputListener.PacketOutputEvent;
...
public interface ConnectionPacketOutputListener extends Listener
{
	 ...
	 */
	public static class ConnectionPacketOutputEvent extends CancellableEvent<ConnectionPacketOutputListener>
	{
